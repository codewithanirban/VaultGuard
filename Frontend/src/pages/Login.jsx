 ...
 *
 * - On submit: calls login() from AuthContext → redirects to /dashboard.
 * - Displays inline error messages on API failure.
 * - "Continue with Google" button triggers the OAuth redirect.
...
const Login = () => {
  ...
  /**
   * Handles form submission — authenticates the user.
    ...
    <div className="page page--auth">
      <div className="auth-card">
        <div className="auth-header">
          <h1>Welcome Back</h1>
          <p className="auth-subtitle">Sign in to your VaultGuard account</p>
        </div>
